    ...
    <div class="widget">
        ...
        <div class="stat-grid">
            <div class="stat-card">
                ...
                <div class="stat-text"><div class="number">${s.totalPublications.toLocaleString()}</div><div class="label">Publications</div></div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-text"><div class="number">${s.totalCitations.toLocaleString()}</div><div class="label">Citations</div></div>
            </div>
            <div class="stat-card">
                <svg class="stat-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
                <div class="stat-text"><div class="number">${s.totalDatasets.toLocaleString()}</div><div class="label">Datasets</div></div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-text"><div class="number">${s.uniqueAuthors.toLocaleString()}</div><div class="label">Researchers</div></div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-text"><div class="number">${s.uniqueInstitutions.toLocaleString()}</div><div class="label">Institutions</div></div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-text"><div class="number">${s.uniqueCountries}</div><div class="label">Countries</div></div>
            </div>
        </div>
    </div>
</body>
